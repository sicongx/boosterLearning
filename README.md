...
- training a tabular Q-learning policy
...
4. train tabular Q-learning through a generic microsimulation environment
...
- records patient-level trajectory artifacts
...
- trains tabular Q-learning through the generic learner
- evaluates four policies: learned, observed data, always-booster, and never-booster

## Public example data

The example dataset intended for public use in this repository is:

- `facsimile_data.csv`

This file is synthesized and is meant to replace the original private `RLdata_for_RNN_01242024.csv` in examples, documentation, and released code.
...
These files reflect the older script-by-script workflow. They are still useful as references for how the original implementation was organized.
